...
layers2projects = db.Table('layers2projects',
    db.Column('layer_id', db.Integer, db.ForeignKey('layer.layer_id'), primary_key=True),
    db.Column('project_id', db.Integer, db.ForeignKey('project.project_id'), primary_key=True)
)
...
class Project(db.Model):
    ...
    layers = db.relationship('Layer', secondary=layers2projects, lazy='subquery',
        backref=db.backref('projects', lazy=True))
